...
const loadFrenchPosts = async function (): Promise<Array<Post>> {
  ...
  // Filter only French posts (those in the fr/ subdirectory)
...
/** Get static paths for French blog list with pagination */
...
/** Get related French posts based on category and tags */
...
/** Find French posts by their IDs */
